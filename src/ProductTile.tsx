...
export interface ProductTileProps {
  imageUrl: string;
  type?: PRODUCT_TYPE.PRODUCT | PRODUCT_TYPE.COLLECTION;
  name?: string;
  shop?: string;
  price?: string;
...
export const ProductTile = ({ imageUrl, type = PRODUCT_TYPE.PRODUCT, name, shop, price, addedToWishList }: ProductTileProps) => {
  ...
  return(
      <div className="group/product-tile w-full h-full rounded cursor-pointer">
        <div className="w-full h-full relative rounded bg-gray-100 flex justify-center items-center">
            ...
            {
                type === PRODUCT_TYPE.PRODUCT? (inWishList ?
