    ...
    <>
      ...
      >
        ...
        <input
          ...
          value={value}
          className="ml-2 outline-0 w-full placeholder:text-base  md:placeholder:text-xs placeholder:font-normal placeholder:leading-4 placeholder:text-gray-500 text-base md:text-xs text-gray-800 focus:border-transparent focus:ring-0"
